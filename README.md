...
Atuação com suporte presencial em diferentes estados do Brasil, infraestrutura em obras, controle de ativos e licenças, instalação e configuração de redes, câmeras e pontos de internet com fibra óptica. Realização de treinamentos para usuários e jovens aprendizes.

### MJRE Construtora · Estágio em TI
**Maio de 2025 — setembro de 2025**

Suporte técnico a usuários, configuração e manutenção de equipamentos de rede, gerenciamento de arquivos com Microsoft 365 e OneDrive, suporte a sistemas corporativos, certificados digitais A1 e A3 e apoio à infraestrutura em ambientes externos.

## Formação e aprendizado

**Gestão da Tecnologia da Informação · Estácio · 2026**

Cursos complementares pela Estácio:
